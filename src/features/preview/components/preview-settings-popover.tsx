...
function PreviewSettingsPopover({
    ...
    // defining our form functions here
    const form = useForm({
        defaultValues:{
        ...
        validators: {
            // we will validate on submit using formSchema
            onSubmit: formSchema,
        },
        onSubmit: async({value}) =>{
            ...
            setOpen(false);
            onSave?.();//if onSave exists then run it
        }
    })
                ...
                <div className="space-y-4">
                    <div className="space-y-1">
                        ...
                        <p className="text-xs text-muted-foreground">
                            Configure how your project runs in preview.
                        </p>
                    </div>
                    <form.Field 
                        name="installCommand"
