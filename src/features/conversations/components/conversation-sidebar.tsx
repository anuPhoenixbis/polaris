...
function ConversationSidebar({projectId}:ConversationSidebarProps) {
    ...
    const handleSubmit = async(message: PromptInputMessage) =>{
        ...
        if(isProcessing && !message.text){
            await handleCancel()//this will trigger the cancel req
            setInput("")
            return;
        }
  ...
  return (
    <>
    {/* rendering the past conversations dialog outside the conversations-sidebar */}
                            ...
                            <MessageContent>
                                {message.status === "processing" ? (
                                    ...
                                    <span className='text-muted-foreground italic'>
                                        {/* if the message is cancelled then show this otherwise go on to see the content*/}
                                        Request cancelled
                                    </span>
                                ) : 
                                (
