...
function ProjectsView() {
    ...
    useEffect(()=>{
        ...
        document.addEventListener("keydown",handleKeyDown);//mounting it to the dom when the effect triggers
        return ()=>document.removeEventListener("keydown",handleKeyDown)//unmounting
    },[])
