...
function Navbar({
    ...
    const handleKeyDown = (e:React.KeyboardEvent)=>{
        if(e.key === "Enter") handleSubmit()//when pressed enter we do the handlesubmit
        else if(e.key === "Escape") setIsRenaming(false)//when pressed esc we fallback to the prev name
    }
