  ...
  return (
    <div 
        ...
        <input 
            ...
            onFocus={(e)=>{
                // for folders we select the entire name of the folder and give the user to take charge here
                if(type==="folder"){
                    e.currentTarget.select();
                }else{//for files we select the entire name of the file and not the value beyond the "." like (in test.jsx ; "test" is selected but ".jsx" is not); thus, a bit of convenience
